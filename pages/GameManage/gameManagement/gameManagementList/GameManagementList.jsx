...
import styles from "./GameManagementList.module.css"

export default function GameManagementList() {
  const columns = [
    ...
    { field: "home_bet", headerName: "홈배팅", type: "number", flex: 1, headerAlign: "center", align: "center" },
  ...
  return (
    <>
      <CustomHeader text={"게임관리"} customStyle={{ height: "38px", width: "100%" }} />

...
function index() {
  ...
  const columns = [
    ...
    { field: "99", headerName: "마켓명", flex: 3 },
    { field: "111", headerName: "기준점", flex: 3 },
    { field: "111", headerName: "결과", flex: 3 },
    { field: "333", headerName: "처리일자", flex: 3 },

...
import styles from "./BettingAnalysis.module.css"
...
export default function BettingAnalysis() {
  ...
  const columns = [
    ...
    { field: "normal", headerName: "이름", flex: 3, headerAlign: "center", align: "center" },
    { field: "evil", headerName: "베팅 수", flex: 1.5, headerAlign: "center", align: "center" },
    { field: "bad", headerName: "총 베팅금", flex: 1.5, headerAlign: "center", align: "center" },
    { field: "danpole", headerName: "총 당첨금", flex: 1.5, headerAlign: "center", align: "center" },
    { field: "danpole2", headerName: "평균 배팅금", flex: 1.5, headerAlign: "center", align: "center" },
    {
      field: "danpole3",
      headerName: "손익",
      flex: 1.5,
      ...
      align: "center",
      renderCell: (params) => {
        const isup = params.formattedValue > 0 ? true : false
        console.log(params)
        return (
          <div style={{ width: "100%", color: isup ? "red" : "blue", textAlign: "center" }}>
  ...
  return (
    <>
      <CustomHeader text={`베팅별 분석 현황 (전체 0)`} customStyle={{ height: "1.979vw", width: "100%" }}>
        <div className={styles.statics}>`수익 : 29,470,093원 오차: 20,094,793원 합계 : 9,006,000원`</div>
      </CustomHeader>

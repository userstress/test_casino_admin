...
import styles from "./MobilePopupList.module.css"

export default function MobilePopupList() {
  const columns = [
    { field: "id", headerName: "번호", flex: 1, type: "number", headerAlign: "center", align: "center" },
    { field: "title", headerName: "제목", flex: 5, headerAlign: "center", align: "left" },
  ...
  return (
    <>
      <CustomHeader text={"모바일 팝업"} customStyle={{ height: "1.979vw", width: "100%" }} />

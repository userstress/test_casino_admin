...
export default function index() {
  return (
    <div className={styles.boardDetailTableWrapper}>
      <table className={styles.boardDetailTable}>
        <colgroup>
          <col width={420}></col>
          <col width={580}></col>
          <col width={250}></col>
        ...
        <thead>
          <tr>
            <th className={styles.title}>게시판 수정</th>
            <th colSpan={3}></th>
          </tr>
        </thead>
        ...
        <tbody>
          ...
          <tr>
            <td>글제목</td>
            <td colSpan={3}>
              <input type="text" placeholder="글제목" value={"축구 아니오"} readOnly />
            </td>
          </tr>

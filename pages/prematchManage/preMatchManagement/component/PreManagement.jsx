...
import styles from "./PreManagement.module.css"
...
function PreManagement() {
  ...
  function getMarketInfoes(datepick) {
    const method = "GET"
    const url = `pre-fixtures?startDate=${datepick.start}&endDate=${datepick.end}`
  ...
  const columns = [
    ...
    },
    {
      ...
      align: "center",
      renderCell: (params) => {
        // return <div style={cellboxall2}>{params.row.fixtureStartDate}</div>

...
function index() {
  ...
  const columns = [
    { field: "num", headerName: "번호", flex: 3 },
    { field: "unover", headerName: "언오버 기준점", flex: 3 },
    { field: "handi", headerName: "핸디캡 기준점", flex: 3 },
    { field: "name", headerName: "기능", flex: 3 },
  ]
      ...
      <div>
        ...
        <div style={{ display: "flex" }}>
          <table style={{ color: "black", borderCollapse: "collapse", textAlign: "center" }}>
            <thead>
              <tr>
                <th style={{ border: "1px solid black" }}>언오버 기준점</th>
                <th style={{ border: "1px solid black" }}>핸디캡 기준점</th>
              </tr>
            </thead>
            <tbody>
              <tr>
